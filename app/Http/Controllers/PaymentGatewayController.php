...
class PaymentGatewayController extends Controller
{
        ...
        switch ($tabpage) {
            ...
            case 'freemopay':
                if (!empty($payment_data['value'])) {
                    ...
                    $payment_data['freemopay_link_api'] = $decodedata->freemopay_link_api;
                    $payment_data['freemopay_username_app'] = $decodedata->freemopay_username_app;
                    $payment_data['freemopay_password_app'] = $decodedata->freemopay_password_app;
                }
                $data  = view('paymentgateway.' . $tabpage, compact('user_data', 'tabpage', 'payment_data'))->render();
                break;
    ...
    public function paymentsettingsUpdates(Request $request)
    {
        ...
        switch ($type) {
            ...
            case 'freemopay':
                $config_data = [
                    'freemopay_link_api' => $data['freemopay_link_api'],
                    'freemopay_username_app' => $data['freemopay_username_app'],
                    'freemopay_password_app' => $data['freemopay_password_app']
                ];
                break;
