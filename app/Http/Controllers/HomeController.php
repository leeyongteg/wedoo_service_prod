...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // @todo @fix Resoudre la requete pour le new_provider
        $data['dashboard'] = [
        ...
        $data['locale'] = session()->get('locale') ?: Cookie::get('locale') ?: app()->getLocale();
    ...
    public function lang($locale)
    {
        ...
        cookie()->queue(cookie('locale', $locale, 60 * 24 * 30)); // 30 jours
        ...
        //     $user->save();
        // }
        // $cookie_language =  cookie('language', $locale, 60 * 24 * 365 * 10);
        // // $cookie_language = request()->cookie('language');
        // response()->cookie($cookie_language);
        // dd($cookie_language, 777);
