...
class ServiceResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $jsonName = json_decode($this->name);
        $name = $jsonName->{$locale};

        $jsonDescription = json_decode($this->description);
        $description = $jsonDescription->{$locale};
        ...
        return [
            ...
            'advance_payment_amount' => $this->advance_payment_amount == null ? 0 : (float) $this->advance_payment_amount,
