<template>
  <div class="booking-list-content">
    <h5 class="mt-5 mb-0 text-capitalize">
      {{ $t('messages.wallet_balance') }}: {{ formatCurrencyVue(wallet_amount) }}
    </h5>
    <div class="mt-0">
      <form @submit="formSubmit">
        ...
        <div class="d-flex align-items-center flex-wrap gap-3">
          <div class="form-check">
            ...
            />
            <label class="form-check-label h6 fw-normal text-capitalize" for="stripe">{{
              $t('messages.stripe')
            }}</label>
          </div>
        </div>
