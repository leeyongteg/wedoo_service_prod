              ...
              <div class="d-sm-flex align-items-center gap-3 justify-content-between">
                ...
                <div class="flex-shrink-0 d-inline-flex align-items-center gap-2 mt-sm-0 mt-2">
                  <span class="text-primary fw-500 d-inline-block position-relative h5"
                    ><span v-if="service.price > 0 && service.type == 'hourly'">{{
                      formatCurrencyVue(service.price)
                    }}</span
                    ><span v-else-if="service.type == 'fixed'"
                      >{{ formatCurrencyVue(service.min_price_range) }} -
                      {{ formatCurrencyVue(service.max_price_range) }}</span
                    >
      ...
      <form @submit="formSubmit">
        ...
        <div class="col-12">
          <template v-if="!isChildComponentVisible">
            <div class="row">
              <div :class="service.type == 'free' ? 'col-lg-12' : 'col-lg-8'">
              ...
              <div class="col-lg-4" v-if="service.type == 'fixed'">
                <div class="booking-list-content">
                    ...
                    <table class="table">
                      <tbody>
                        <tr>
                          ...
                          <td class="pe-0">
                            <span
                              v-if="service.type == 'hourly'"
                              class="d-block text-primary text-end"
                              >{{ formatCurrencyVue(service.price * quantity) }}</span
                            >
                            <span
                              v-if="service.type == 'fixed'"
                              class="d-block text-primary text-end col-12"
                              >+ ( {{ formatCurrencyVue(service.min_price_range * quantity) }} -
                              {{ formatCurrencyVue(service.max_price_range * quantity) }} )</span
                            >
                          </td>
                        </tr>
                      </tbody>
                  ...
                  <div class="mt-5 pt-md-5 pt-3 text-md-end">
                    <div class="d-inline-flex align-items-center flex-wrap gap-3">
                      ...
                      >
                      <!-- @Fix @Todo @Lee remove 1 == 3 -->
                      <button
                        type="submit"
                        v-if="service.is_enable_advance_payment == 1 && 1 == 3"
