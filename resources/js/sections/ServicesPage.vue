                ...
                <div class="row gx-3">
                    <div class="col-sm-4">
                        <select ref="categoryDropdownRef" id="categoryDropdown" v-model="selectedCategory"
                            ...
                            <option v-for="category in category_data" :key="category.id" :value="category.id">
                                {{ category.name }}
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-l2">
                        <div class="d-flex align-items-center flex-sm-row flex-column gap-3 justify-content-lg-end">
                            <div class="d-flex align-items-center gap-1 flex-shrink-0">
                                ...
                                <select ref="sortOptionRef" v-model="selectedSortOption" class="form-select select2"
                                    :disabled="isEmpty">
                            ...
                            <div class="flex-shrink-0">
                                <div class="search-form input-group flex-nowrap align-items-center">
                                    <input type="text" class="form-control rounded-3" v-model="search"
                                        placeholder="Search" :disabled="isEmpty" />
                            ...
                            <button v-if="checkDropdowns" class="btn btn-outline-primary" @click="refreshDropdowns"
                                :disabled="isEmpty">
                                {{ $t('landingpage.reset') }}
                            </button>
                        </div>
...
const columns = ref([{ data: 'name', title: '', orderable: false, order: 'desc' }])
