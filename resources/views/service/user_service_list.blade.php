...
<a href="{{ route('service.create') }}" class="btn btn-sm btn-primary float-right mr-1"><i class="fa fa-plus-circle"></i> {{ __('messages.add_form_title', ['form' => __('messages.service')]) }}</a>
@endif -->
                        </div>
                ...
                <div>
                    <div class="col-md-12">
                        <form action="{{ route('service.bulk-action') }}" id="quick-action-form"
                            class="form-disabled d-flex align-items-center gap-3">
                            @csrf
                            ...
                            <button id="quick-action-apply" class="btn btn-primary" data-ajax="true"
                                ...
                                data-confirmation='true' data-title="{{ __('service', ['form' => __('service')]) }}"
