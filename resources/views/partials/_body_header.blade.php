            ...
            <div class="d-flex align-items-center">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav navbar-list align-items-center ml-auto">
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="search-toggle dropdown-toggle notification_list"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                    class="text-secondary h-6 w-6" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="notification-dropdown">
                                <div class="card notification_data m-0 border-0 shadow-none"></div>
                            </div>
                        </li>
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="search-toggle dropdown-toggle language-toggle"
                                id="languageDropdownMenu" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <?php
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="nav-item nav-icon dropdown-toggle search-toggle pr-0"
                                id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <img src="{{ getSingleMedia(auth()->user(), 'profile_image') }}"
                                    class="img-fluid avatar-rounded bg-light" alt="user">
                                <span
                                    class="user-name mb-0">{{ auth()->user()->first_name . ' ' . auth()->user()->last_name }}</span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-right user-dropdown"
                                aria-labelledby="dropdownMenuButton">
                                <li class="dropdown-item d-flex svg-icon">
                                    <svg class="svg-icon text-secondary mr-0" id="h-01-p" width="20"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a
                                        href="{{ route('setting.index', ['page' => 'profile_form']) }}">{{ __('messages.my_profile') }}</a>
                                </li>
                                @role('provider')
                                    <li class="dropdown-item d-flex svg-icon">
                                        <svg class="svg-icon text-secondary mr-0" id="h-01-p" width="20"
                                        ...
                                        <a
                                            href="{{ route('provider.show', ['provider' => auth()->id()]) }}">{{ __('messages.my_info') }}</a>
                                    </li>
                                @endrole
                                <li class="dropdown-item d-flex svg-icon border-top">
                                    <svg class="svg-icon text-secondary mr-0" id="h-03-p" width="20"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <li class="dropdown-item d-flex svg-icon border-top">
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <svg class="svg-icon text-secondary mr-0" id="h-05-p" width="20"
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
{{-- Define global variable User.id --}}
<script>
    if (!window.User) {
        window.User = {
