    ...
    <div class="row align-items-center">
        <div class="col-lg-4">
            @if (!isset($data->bookingPackage))
                <img src="{{ $serviceimage }}" alt="booking" class="img-fluid rounded-3 w-100 booking-img object-cover">
            @else
                <img src="{{ $data->bookingPackage->package->getFirstMedia('package_attachment')->getUrl() }}"
                    alt="booking" class="img-fluid rounded-3 w-100 booking-img object-cover">
            @endif
        </div>
        <div class="col-lg-8 mt-lg-0 mt-5">
            ...
            <div class="d-flex align-items-center mt-3 gap-1">
                <div class="ratting d-flex align-items-center gap-1">
            ...
            <div
                class="booking-date bg-primary-subtle text-primary font-size-14 d-flex align-items-center position-absolute top-0 gap-1">
                    ...
                    <ul class="list-inline m-0">
                        ...
                        <li class="mb-2">
                            <span class="d-flex gap-3">
                                ...
                                @if (isset($data->provider->display_name))
