                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex justify-content-start align-items-center flex-wrap">
                                                <h4 class="booking-text font-weight-bold mb-2">
                                                    {{ !empty($data['dashboard']['count_total_booking']) ? $data['dashboard']['count_total_booking'] : 0 }}
                                                </h4>
                                                <!-- <h4 class="booking-text font-weight-bold text-break mb-2"> 000000000000 </h4> -->
                                            </div>
                                            <p class="booking-text mb-0">
                                                {{ __('messages.total_name', ['name' => __('messages.bookings')]) }}</p>
                                        </div>
                                        <div class="d-flex align-items-center flex-column col-auto">
                                            <div
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="booking-text mb-0">
                                                {{ __('messages.total_name', ['name' => __('messages.services')]) }}</p>
                                        </div>
                                        <div class="d-flex flex-column col-auto">
                                            <div
                                                class="iq-card-icon iq-card-icon-service icon-shape rounded-circle text-white shadow">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex justify-content-start align-items-center flex-wrap">
                                                ...
                                                <p class="text-danger font-weight-bold mb-0 ml-3"></p>
                                            </div>
                                            <p class="booking-text mb-0">
                                        ...
                                        <div class="d-flex flex-column col-auto">
                                            <div
                                                class="iq-card-icon iq-card-icon-provider icon-shape rounded-circle text-white shadow">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex justify-content-start align-items-center flex-wrap">
                                                <h4 class="booking-text font-weight-bold mb-2">
                                                    {{ getPriceFormat(round($data['total_revenue'])) }}</h4>
                                                <p class="text-danger font-weight-bold mb-0 ml-3"></p>
                                            </div>
                                            <p class="booking-text mb-0">
                                        ...
                                        <div class="d-flex flex-column col-auto">
                                            <div
                                                class="iq-card-icon iq-card-icon-revenue icon-shape rounded-circle text-white shadow">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                ...
                                <li style="pointer-events:none;">
                                    <div class="media gap-3">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span>{{ optional($datetime)->date_format && optional($datetime)->time_format
                                                ? date(optional($datetime)->date_format, strtotime($customer->created_at)) .
                                                    ' / ' .
                                                    date(optional($datetime)->time_format, strtotime($customer->created_at))
                                                : '' }}</span>
                    ...
                    <div class="card-body">
                        <ul class="common-list p-0">
                            ...
                            @foreach ($data['dashboard']['upcomming_booking'] as $booking)
                                <li class="d-flex align-items-start align-items-lg-center justify-content-between flex-column flex-lg-row flex-wrap gap-2"
                                    ...
                                    <div class="media align-items-center gap-3">
                                        ...
                                        <div class="media-body">
                                            <h5>#{{ $booking->id }}</h5>
                                            <span>{{ optional($datetime)->date_format && optional($datetime)->time_format
                                                ? date(optional($datetime)->date_format, strtotime($booking->date)) .
                                                    ' / ' .
                                                    date(optional($datetime)->time_format, strtotime($booking->date))
                                                : '' }}</span>
                                            {{-- <span>{{(date("$datetime->date_format / $datetime->time_format", strtotime($booking->date)))}}</span> --}}
                                        </div>
                                    </div>
                                    <span
                                        class="badge rounded-pill badge-pending text-capitalize px-3 py-2">{{ $booking->status }}</span>
                                </li>
                            @endforeach
                        </ul>
                    </div>
