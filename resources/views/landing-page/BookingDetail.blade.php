    ...
    <div class="section-padding">
        <div class="container">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    <p class="text-success text-capitalize m-0">
                                ...
                                <h6 class="text-capitalize text-body m-0">{{ __('landingpage.service_total_time') }}: <span
                                        class="text-primary">
                            ...
                            <div class="col-md-4 text-md-end mt-md-0 mt-5">
                                @php
                                    $imageSource = null;
            ...
            @if (!empty($bookingData['booking_detail']['booking_package']))
                <div class="py-lg-5 my-lg-5 my-3 py-3">
                    <div class="row">
                        <div class="col-lg-6 position-relative pe-xl-5 py-5">
                            <h6 class="font-size-18 text-capitalize mb-4 mt-0">{{ __('landingpage.include_package') }}</h6>
                            @foreach ($bookingData['booking_detail']['booking_package']['services'] as $servicepackage)
                                ...
                                @endphp
                                <div
                                    class="border-bottom d-flex align-items-sm-center aling-items-start flex-sm-row flex-column mb-4 gap-5 pb-4">
                                    <div class="provider-image-container flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-sm-flex my-3 gap-2">
                                            <ul
                                                class="list-inline mt-sm-0 d-flex align-items-center category-list lh-1 mb-0 mt-2 flex-wrap p-0">
            ...
            @if ($bookingData['booking_detail']['BookingAddonService'])
                <div class="py-lg-5 my-lg-5 my-3 py-3">
                    <div class="row">
                        <div class="col-lg-6 position-relative pe-xl-5 py-5">
                            <h6 class="font-size-18 text-capitalize mb-4 mt-0">{{ __('landingpage.Add-ons') }}</h6>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-7 position-relative">
                        @if (!empty($bookingData['handyman_data']))
                            <span class="vr position-absolute h-100 d-md-block d-none end-0 top-0"></span>
                        @endif
                        <div class="row">
                            @if (!empty($bookingData['provider_data']))
                                <div class="col-lg-5 col-sm-6 position-relative">
                                    <h6 class="font-size-18 text-capitalize mb-4 mt-0">
                                        {{ __('landingpage.about_provider') }}
                                    </h6>
                                    <div class="img mb-4 flex-shrink-0">
                                        <a href="{{ route('provider.detail', $bookingData['provider_data']['id']) }}">
                                            <img src="{{ $bookingData['provider_data']['profile_image'] }}"
                                    ...
                                    <div class="content">
                                        <a href="{{ route('provider.detail', $bookingData['provider_data']['id']) }}">
                                            <h5 class="text-capitalize mb-1 mt-0">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                            ...
                                            <a
                                                href="{{ route('rating.all', ['provider_id' => $bookingData['provider_data']['id']]) }}"><span
                                                    class="h6 lh-1">({{ round($bookingData['provider_data']['providers_service_rating'], 1) }})</span></a>
                                        </div>
                                        <ul class="list-inline mb-0 mt-3 p-0">
                            ...
                            @if (!empty($bookingData['handyman_data']))
                                <div class="col-lg-5 col-sm-6 mt-sm-0 mt-5">
                                    ...
                                    @foreach ($bookingData['handyman_data'] as $handyman)
                                        ...
                                        <div class="content">
                                            <a href="{{ route('handyman-detail', $handyman['id']) }}">
                                                <h5 class="text-capitalize mb-1 mt-0">{{ $handyman['display_name'] }}</h5>
                                            </a>
                                            <div class="d-flex align-items-center flex-wrap gap-1">
                                                <div>
                                                    <rating-component :readonly=true :showrating="false"
                                            ...
                                            @if ($bookingData['booking_detail']['status'] == 'completed')
                                                <handyman-rating :booking_id="{{ $bookingData['booking_detail']['id'] }}"
                                                    ...
                                                    :handymanrating="{{ isset($handymanrating) ? $handymanrating : '' }}"></handyman-rating>
                                            @endif
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    @if ($bookingData['booking_detail']['amount'] > 0)
                        <div class="col-lg-6 col-md-5 mt-md-0 mt-5">
                            <div class="position-relative px-lg-3">
                                <h6 class="font-size-18 text-capitalize mb-3 mt-0">{{ __('landingpage.price_detail') }}
                                </h6>
                                        ...
                                        <tbody>
                                            ...
                                            @if (!empty($bookingData['booking_detail']['final_discount_amount']))
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="d-block text-success text-end">-{{ getPriceFormat($bookingData['booking_detail']['final_discount_amount']) }}</span>
                                                        <!-- <span class="d-block text-success text-end">- {{ getPriceFormat($bookingData['booking_detail']['discount'] / 100) }}</span> -->
                                                    </td>
                                                </tr>
                                            @endif
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="d-block text-end">{{ getPriceFormat($bookingData['booking_detail']['final_sub_total']) }}</span>
                                                </td>
                                            </tr>
                                            ...
                                            @if ($bookingData['coupon_data'])
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="d-block text-success text-end">-{{ getPriceFormat($bookingData['coupon_data']['discount']) }}</span>
                                                    </td>
                                                </tr>
                                            @endif
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($bookingData['booking_detail']['final_total_tax'] > 0)
                                                        <span class="d-block text-danger text-end"><i type="button"
                                                    ...
                                                    @else
                                                        <span
                                                            class="d-block text-danger text-end">+{{ getPriceFormat($bookingData['booking_detail']['final_total_tax']) }}</span>
                                                    @endif
                                            </tr>
                                            ...
                                            <tr class="bg-light">
                                                ...
                                                <td class="py-2">
                                                    <h6 class="m-0 text-end">
                                                        {{ getPriceFormat($bookingData['booking_detail']['total_amount'] + $bookingData['booking_detail']['extra_charges_value']) }}
                                                    </h6>
                                                </td>
                                            </tr>
                                            ...
                                            @if ($bookingData['service']['is_enable_advance_payment'] == 1)
                                                <tr class="bg-light">
                                                    ...
                                                    <td class="py-2">
                                                        ...
                                                        @endphp
                                                        <h6 class="m-0 text-end">
                                                            {{ getPriceFormat(($bookingData['booking_detail']['total_amount'] * $bookingData['service']['advance_payment_amount']) / 100) }}
                                                        </h6>
                                                    </td>
                                                </tr>
                                            @endif
                                ...
                                {{-- @if (count($bookingData['booking_detail']['extra_charges']) > 0 || !empty($bookingData['booking_detail']['payment_id']))
                                    <span class="vr position-absolute h-100 d-lg-block d-none end-0 top-0"></span>
                                @endif --}}
                            </div>
                            <div class="px-lg-3 mt-5">
                                @if (count($bookingData['booking_detail']['extra_charges']) > 0)
                                    <h6 class="font-size-18 text-capitalize mb-3 mt-0">
                                ...
                                @if (!empty($bookingData['booking_detail']['payment_id']))
                                    <h6 class="font-size-18 text-capitalize mb-3 mt-5">
                                        ...
                                        <table class="table-borderless mb-0 table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pd-0">
                                                        <span
                                                            class="d-block text-capitalize text-end">{{ $bookingData['booking_detail']['payment_method'] }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="ps-0">
                                                    ...
                                                    <td class="pd-0">
                                                        <span
                                                            class="d-block text-capitalize text-end">{{ str_replace('_', ' ', $bookingData['booking_detail']['payment_status']) }}</span>
                                                    </td>
                                                </tr>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    @if (count($bookingData['rating_data']) !== 0)
                        <div class="pt-lg-5 mt-lg-5 mt-3 pt-3">
                            <div class="mt-3">
                                ...
                                <ul class="comment-list list-inline m-0">
                                    ...
                                    @foreach ($bookingData['rating_data'] as $ratingData)
                                        <li class="comment border-bottom mb-5 pb-5">
                                            @if ($counter % 2 == 0)
                    ...
                    @if ($bookingData['booking_detail']['taxes'] !== null)
                        @foreach ($bookingData['booking_detail']['taxes'] as $tax)
                            <div class="d-flex justify-content-between">
                                <p>{{ $tax['title'] }}</p>
                                @if ($tax['type'] == 'percent')
                                    <p>{{ getPriceFormat(($tax['value'] * $bookingData['booking_detail']['amount']) / 100) }}
                                    </p>
                                @else
                            ...
                            <li class="done">
                                <div class="status-timeline-wrapper position-relative">
                                    <div class="timeline-time-block text-md-end">
                                        <h6 class="text-uppercase time m-0">
                                            {{ date($date_time['time_format'], strtotime($time)) }}</h6>
                                        <p class="text-capitalize date m-0">
                                            {{ date($date_time['date_format'], strtotime($date)) }}</p>
                                    </div>
                                    <div class="timeline-content-block text-md-start">
                                        <h6 class="text-capitalize title m-0">{{ $bookingactivity['activity_type'] }}
                                        </h6>
                                        <p class="text-capitalize description m-0">
