            ...
            <div class="row">
                <div class="col-lg-8 pe-xxl-5">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <ul class="service-meta-list list-inline d-flex align-items-center m-0 flex-wrap">
                            <li>
                    ...
                    @else
                        <img src="{{ asset('images/default.png') }}" alt=""
                            class="img-fluid rounded-3 w-100 mt-4 object-cover" />
                    @endif
                    @if (!empty($serviceData['service_detail']['description']))
                        <div class="pt-lg-5 mt-5 pt-3">
                    ...
                    {{-- <div class="pt-lg-5 mt-5 pt-3">
                        ...
                        <div class="rounded-3 about-provider-box border p-5">
                            <div
                    ...
                    @if ($serviceData['serviceaddon'])
                        <div class="pt-lg-5 mt-5 pt-3">
                            ...
                            @foreach ($serviceData['serviceaddon'] as $serviceaddon)
                                <div
                                    class="border-bottom d-flex align-items-sm-center aling-items-center justify-content-between flex-sm-row flex-column mb-4 gap-2 pb-4">
                    ...
                    @endif
                    @if ($serviceData['service_detail']['type'] !== 'free')
                        <div class="pt-lg-5 mt-5 pt-3">
                            <h5 class="text-capitalize mb-3">{{ __('landingpage.order_detail') }}</h5>
                            <div class="rounded-3 border p-5">
                                <h6 class="mb-1">{{ __('messages.service') }}</h6>
                                <p class="text-capitalize m-0">{{ $serviceData['service_detail']['name'] }}</p>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="py-2 pe-0 text-end">
                                                        <h6 class="text-primary">
                                                            @if ($serviceData['service_detail']['type'] == 'hourly')
                                                                +{{ getPriceFormat($serviceData['service_detail']['price']) }}
                                                            @elseif($serviceData['service_detail']['type'] == 'fixed')
                                                              + ( {{ getPriceFormatOnlyWithEndZero($serviceData['service_detail']['min_price_range']) .
                                                                    ' - ' .
                                                                    getPriceFormatOnlyWithEndZero($serviceData['service_detail']['max_price_range']) .
                                                                    ' ' .
                                                                    getCurrencySymbol() }} )
                                                            @endif
                                                        </h6>
                                                ...
                                                @if (!empty($serviceData['service_detail']['discount']))
                                                    <tr>
                                                        ...
                                                        <td class="py-2 pe-0 text-end">
                                                            @if ($serviceData['service_detail']['type'] == 'fixed')
                                                                <span
                                                                    class="text-success">-{{ __('messages.fixed_price_not_define') }}</span>
                                                            @elseif($serviceData['service_detail']['type'] == 'hourly')
                                                                <span
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="py-2 pe-0 text-end">
                                                        <h6 class="text-primary">
                                                            ...
                                                            @elseif(
                                                                $serviceData['service_detail']['type'] == 'fixed' &&
                                                                    isset($subtotal['min_range_price']) &&
                                                                    isset($subtotal['max_range_price']))
                                                                {{ getPriceFormatOnlyWithEndZero($subtotal['min_range_price']) .
                                                                    ' - ' .
                                                                    getPriceFormatOnlyWithEndZero($subtotal['max_range_price']) .
                                                                    ' ' .
                                                                    getCurrencySymbol() }}
                                                            @endif
                                                        </h6>
                                    ...
                                    <div class="text-end">
                                        @if (auth()->check() && auth()->user()->user_type == 'user')
                                            <a href="{{ route('book.service', ['id' => $serviceData['service_detail']['id']]) }}"
                                                class="btn btn-lg btn-primary continue-button">{{ __('messages.continue') }}</a>
                                        @else
                                            <a href="{{ route('user.login', ['service_id' => $serviceData['service_detail']['id']]) }}"
                                                class="btn btn-lg btn-primary">{{ __('messages.continue') }}</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="pt-lg-5 mt-5 pt-3">
                            <div class="row align-item-center">
                                ...
                                @if (count($serviceData['service_detail']['servicePackage']) > 3)
                                    <div class="col-sm-6 mt-sm-0 text-sm-end mt-3">
                                        <a
                            ...
                            <div class="mt-5">
                                <div class="position-relative swiper swiper-general our-service overflow-hidden">
                                    @auth
                        ...
                        <div class="section-padding px-0 pb-0">
                            <div class="row align-items-center mb-5">
                                ...
                                @if (count($total_ratings) !== 0)
                                    <div class="col-sm-3 mt-sm-0 text-sm-end mt-3">
                                        <a
                    ...
                    <div class="pt-lg-5 mt-5 pt-3">
                        ...
                        <div class="position-relative swiper swiper-general our-service overflow-hidden" data-slide="2"
                ...
                <div class="col-lg-4 ps-xxl-5 mt-lg-0 mt-5">
                    <div class="bg-light rounded-3 p-5">
                        <div class="d-flex align-items-center justify-content-between mb-3 gap-3">
                            <div class="div">
                                ...
                                @if ($serviceData['service_detail']['price'] == 0 && $serviceData['service_detail']['type'] == 'free')
                                    <h4 class="text-primary mt-2">Free</h4>
                                @elseif($serviceData['service_detail']['type'] == 'fixed')
                                    {{-- &&
                                        $serviceData['service_detail']['min_price_range'] !== 0 &&
                                         $serviceData['service_detail']['max_price_range'] !== 0
                                        --}}
                                ...
                                @elseif($serviceData['service_detail']['min_price_range'] == 'hourly')
                                    {{-- &&
                                    $serviceData['service_detail']['price'] !== 0 &&
                                        $serviceData['service_detail']['max_price_range'] == 0 --}}
                                    <h4 class="text-primary mt-2">
                            ...
                            <div class="flex-shrink-0">
                                @if (auth()->check() && auth()->user()->hasRole('user'))
                                    @if (empty($favouriteService))
                                        <form method="POST" id="favoriteForm">
                                            ...
                                            <button type="button"
                                                class="btn btn-light rounded-circle serv-whishlist text-primary avatar-30 save_fav bg-white p-0">
                                    ...
                                    @else
                                        <form method="POST" id="favoriteForm">
                                            ...
                                            @endif
                                            <button type="button"
                                                class="btn btn-light rounded-circle serv-whishlist text-primary avatar-30 delete_fav bg-white p-0">
                                ...
                                @else
                                    <form method="GET" id="favoriteForm" action="{{ route('user.login') }}">
                                        @csrf
                                        <button type="submit"
                                            class="btn btn-light rounded-circle serv-whishlist text-primary avatar-30 bg-white p-0">
                                            <svg width="16" height="16" viewBox="0 0 12 13" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M1.43593 6.29916C0.899433 4.62416 1.52643 2.70966 3.28493 2.14316C4.20993 1.84466 5.23093 2.02066 5.99993 2.59916C6.72743 2.03666 7.78593 1.84666 8.70993 2.14316C10.4684 2.70966 11.0994 4.62416 10.5634 6.29916C9.72843 8.95416 5.99993 10.9992 5.99993 10.9992C5.99993 10.9992 2.29893 8.98516 1.43593 6.29916Z"
                    ...
                    @if ($serviceData['service_detail']['is_slot'] == 1)
                        <div class="bg-light rounded-3 mt-5 p-5">
                            <h5 class="mb-2">{{ __('landingpage.available_days') }}</h5>
                            <ul class="list-inline d-flex align-items-center m-0 flex-wrap gap-2 p-0">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="social-login mt-3">
                        <ul class="list-inline d-flex align-items-center justify-content-center m-0 flex-wrap gap-3">
                            <li>
                                <a href="#">
