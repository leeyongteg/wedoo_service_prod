...
@section('content')
    ...
    <div class="padding-top-bottom-90 bg-light">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-xl-6">
                    <div class="me-xl-5 pe-xl-5 me-0 pe-0">
                        @if ($sectionData && isset($sectionData['section_1']) && $sectionData['section_1']['section_1'] == 1)
                            <div class="iq-title-box mb-5">
                                <div class="iq-title-box">
                                    ...
                                    <p class="iq-title-desc line-count-3 text-body mb-0 mt-3">
                ...
                <div class="col-xl-6 px-xl-0 mt-xl-0 mt-5">
                    <div class="position-relative swiper iq-team-slider mySwiper overflow-hidden">
                        <div class="swiper-wrapper">
                            @foreach ($sectionData['section_1']['provider_id'] as $providerId)
                                @php
                                    //  @todo   ajouter la relation with('getServiceRating') pour le user
                                    $user = App\Models\User::where('user_type', 'provider')
                                        ->where('id', $providerId)
                                        ->with('getServiceRating')
                                        ->where('status', 1)
                                        ->first();
                                ...
                                @if ($user)
                                    <div class="swiper-slide">
                                        <div class="justify-content-center service-slide-items-4 mt-5">
                                            <div class="col">
                                                <div class="iq-banner-img position-relative">
                                                    ...
                                                    <div class="position-relative d-flex justify-content-center card-box">
                                                        <div class="card-description d-inline-block rounded-3 text-center">
                                                            <div class="cart-content">
                                                                <h6 class="heading text-capitalize fw-500">
                                                                    {{ $user->display_name }}</h6>
                                                                <span
                                                                    class="desc d-flex align-items-center justify-content-center mt-2 text-white">
                                                                    <div class="d-flex align-items-center flex-wrap gap-1">
                                                                        ...
                                                                        <h6 class="font-size-12 rating-text lh-1 m-0">
            ...
            <div class="container">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <a href="{{ route('category.list') }}"
                        class="btn btn-link text-capitalize font-size-14 flex-shrink-0 p-0">{{ __('messages.view_all') }}</a>
                </div>
                ...
                <div>
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        ...
                        <a href="{{ route('service.list') }}"
                            class="btn btn-link flex-shrink-0 p-0">{{ __('messages.view_all') }}</a>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <div class="iq-title-box center text-center">
                                    ...
                                    <p class="iq-title-desc line-count-3 text-body mb-0 mt-3">
                                        {{ $sectionData['section_8']['description'] }}</p>
    ...
    @if ($sectionData && isset($sectionData['section_5']) && $sectionData['section_5']['section_5'] == 1)
        <div class="bg-primary-subtle overflow-hidden">
            <div class="provider-section position-relative container">
                @php
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-8 col-md-12">
                        <div class="iq-title-box mb-5 px-3 text-center">
                            <h2 class="text-capitalize line-count-2">{{ $sectionData['section_5']['title'] }}</h2>
                            <p class="iq-title-desc line-count-3 text-body mb-0 mt-3">
                                {{ $sectionData['section_5']['description'] }}</p>
                        </div>
                        <div
                            class="d-flex justify-content-center align-items-center flex-column flex-md-row px-3 pt-3 text-center">
                            <a class="bg-primary fw-bolder rounded-3 letter-spacing-64 px-5 py-3 text-white"
    ...
    @if ($sectionData && isset($sectionData['section_9']) && $sectionData['section_9']['section_9'] == 1)
        <div class="section-padding bg-light px-0">
            <div class="container-fluid px-xxl-3">
                <div class="row">
                    <div class="col-12">
                        <div class="iq-title-box center mb-2 text-center">
                        ...
                        <div class="mb-5 text-center">
                            <div
                                class="d-inline-flex align-items-center flex-sm-row flex-column bg-body rounded-5 gap-2 px-5 py-3">
    ...
    @if ($sectionData && isset($sectionData['section_6']) && $sectionData['section_6']['section_6'] == 1)
        <div class="section-padding">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="bg-primary rounded-3 position-relative overflow-hidden px-5">
                                ...
                                <div class="px-xl-3">
                                    <div class="row align-items-center">
                                        <div class="col-lg-6 position-relative my-5">
                                            <div class="iq-title-box">
                                                <h2 class="text-capitalize line-count-2 text-white">
                                                    {{ $sectionData['section_6']['title'] }}</h2>
                                                <p class="line-count-3 mb-0 mt-3 text-white">
                                                    {{ $sectionData['section_6']['description'] }}
                                                </p>
                                            </div>
                                        ...
                                        <div class="col-lg-6 mt-lg-0 position-relative align-self-end mt-5 text-center">
                                            @if ($mediaMainImage)
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 mt-lg-0 mt-3">
                        <p class="line-count-3 m-0">{{ $sectionData['section_7']['description'] }}</p>
                    </div>
                </div>
                @php
                ...
                <div class="row align-items-center pt-lg-5 mt-5">
                    ...
                    <div class="col-lg-6 mt-lg-0 ps-xl-5 mt-5">
