...
Route::group(['middleware' => ['auth', 'verified']], function () {
	...
	Route::group(['middleware' => ['permission:service list']], function () {
		...
		// @author Lee
		Route::get('service-provider-subscription/{id}', [ServiceController::class, 'subscriptionSerciceCreate'])->name('service.provide-subscription');
		Route::post('service-provider-subscribe/', [ServiceController::class, 'subscribeServiceByProvider'])->name('service.provider-subscribe');
	});
	...
	Route::resource('providerpayout', ProviderPayoutController::class)->except('destroy', 'create');
    ...
    /**
     * @Fixme: LEE au cas ou nous avons un probleme avec la route en POST
     */
